...
zip -r example_project ./example_project/*
```
...
* update code locally, .red[rebuild container], run code in container, ...
* tweak figures locally, .red[rebuild container], compile report in container, ...
  * how to view report?

Want to .green[update code locally] + have code .green[available instantly] in container. 
...
.code-box[
davidbenkeser$ docker run -v /path/to/project/R:/project/R ex-proj
]
