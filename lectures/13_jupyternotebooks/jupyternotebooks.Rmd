...
Example: The `interact` widget generates UI controls for function arguments then calls the function with those arguments when you manipulate the controls interactively
...
## Interactive plots with plotly (Ipython or IRkernel)
...
Can't choose between R and Python? Use them both at the same time in one notebook!
