...
date: 'INFO550<br><br>`r icons::fa("link")` [.white[bit.ly/info550]](https://bit.ly/info550) <br> `r icons::fa("book")` [.white[Additional reading]](https://benkeser.github.io/info550/readings#command-line) <br> `r icons::fa("code")` <a href="commandline.sh" download="commandline.sh" style="color:white">Code chunks</a>'
