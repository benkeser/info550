...
recording: "7f16bcc8-68e5-4271-b5dd-ac5600e70789"
start: "0:0:0"
...
An example: in [a recent paper](https://www.sciencedirect.com/science/article/pii/S1047279720301769), we looked at county-level characteristics by proportion of county that was African-American. The analysis started looking at </> 14% (the national average). This was an arbitrary choice made at the outset of the analysis. So when I wrote the code to produce summary statistics stratifying on this characteristic, I wrote it so one could provide any arbitrary number/s and obtain characteristics. Eventually, they wanted to see it broken down by 14/25% and by 14/25/50%. They ended up not liking the look of the tables, so we went back to </>14 (trivial). For me, all I needed to do was change __a single function input__. This was a (rare) success story for me in generalizing code. 
