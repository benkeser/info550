...
Personally, I use git within Dropbox folders. I hardly ever use Dropbox to revert to saved versions of files, because I save files after every sentenceI type out of habit. However, I very often use git revert when developing code. 
