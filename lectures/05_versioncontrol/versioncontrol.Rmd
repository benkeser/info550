...
date: 'INFO550<br><br>`r icons::fa("link")` [.white[bit.ly/info550]](https://bit.ly/info550) <br> `r icons::fa("book")` [.white[Additional reading]](https://benkeser.github.io/info550/readings#git-and-github) <br> `r icons::fa("code")` <a href="versioncontrol.sh" download="versioncontrol.sh" style="color:white">Code chunks</a> '
