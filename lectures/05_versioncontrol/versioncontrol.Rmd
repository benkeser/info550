...
date: 'INFO550<br><br>`r icons::fontawesome("link")` [.white[bit.ly/info550]](https://bit.ly/info550) <br> `r icons::fontawesome("book")` [.white[Additional reading]](https://benkeser.github.io/info550/readings#git-and-github) <br> `r icons::fontawesome("code")` <a href="versioncontrol.sh" download="versioncontrol.sh" style="color:white">Code chunks</a> '
